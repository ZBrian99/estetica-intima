...
export const categories: CategoryData[] = [
	...
	},
	{
		...
		slug: 'mio-up',
		className: 'us:col-span-3 order-5 sm:col-start-11 sm:col-span-8 sm:row-start-1 us:row-span-2  sm:row-span-3 ',
		variant: 'primary',
		weight: 8,
		image: {
	...
	},
	{
		...
		slug: 'alpha-synergy',
		className: 'us:col-span-3 order-3 sm:col-start-19 sm:col-span-6 sm:row-start-1 us:row-span-2 sm:row-span-3',
		variant: 'primary',
		weight: 8,
		image: {
