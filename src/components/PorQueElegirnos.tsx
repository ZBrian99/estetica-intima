        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {ventajas.map((ventaja, index) => (
            ...
            >
              ...
              {/* Icon */}
              <div
                className={`inline-flex items-center justify-center w-16 h-16 ${ventaja.fallbackBg} bg-gradient-to-br ${ventaja.gradient} rounded-2xl text-white mb-6 group-hover:scale-110 transition-transform duration-300`}
              >
                {ventaja.icon}
              </div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">{ventaja.descripcion}</p>
            </div>
          ))}
        </div>
