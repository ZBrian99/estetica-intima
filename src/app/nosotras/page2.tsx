...
const NosotrosPage = () => {
	...
	return (
		<div className='min-h-screen bg-gray-50'>
			{/* Hero Section */}
			<section className='bg-primary-500 bg-gradient-to-r from-purple-600 to-primary-500 text-white py-16'>
				<div className='max-w-7xl mx-auto px-4'>
					<div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
						...
						<div>
							...
							<h1 className='text-4xl md:text-5xl font-bold mb-6'>Conocé Íntima MDQ</h1>
							<p className='text-xl text-purple-100 mb-8 leading-relaxed'>
								Somos un centro de estética integral especializado en realzar tu belleza natural con los más altos
				...
				<div className='max-w-7xl mx-auto px-4'>
					...
					<div className='min-h-[500px]'>
						...
						{activeTab === 'historia' && (
							<div className='bg-white rounded-2xl shadow-lg p-8 md:p-12 animate-fade-in'>
								<div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
									<div>
										...
										<div className='space-y-4 text-gray-600 leading-relaxed'>
											<p>
												Íntima MDQ nació en 2016 con la visión de crear un espacio donde cada mujer pudiera sentirse
												cómoda, segura y confiada mientras cuida su belleza y bienestar.
											</p>
											<p>
												Comenzamos como un pequeño centro especializado en depilación láser, pero rápidamente nos
												expandimos para ofrecer una gama completa de tratamientos de estética integral, siempre
												manteniendo nuestro compromiso con la excelencia y la atención personalizada.
											</p>
											<p>
												Hoy, después de más de 8 años en el mercado, nos enorgullece ser uno de los centros de estética
												más reconocidos de Mar del Plata, con más de 2500 clientas que confían en nosotros para cuidar
												su belleza.
											</p>
										</div>
									</div>
								...
								<div className='grid grid-cols-1 md:grid-cols-2 gap-8 mt-12'>
									<div className='bg-primary-50 bg-gradient-to-br from-primary-50 to-purple-50 p-8 rounded-2xl'>
										...
										<p className='text-gray-600 leading-relaxed'>
											Ser el centro de estética integral de referencia en Mar del Plata, reconocido por la excelencia en
											nuestros tratamientos y la calidez en nuestro servicio.
										</p>
									</div>
									<div className='bg-primary-50 bg-gradient-to-br from-purple-50 to-primary-50 p-8 rounded-2xl'>
										...
										<p className='text-gray-600 leading-relaxed'>
											Brindar tratamientos de estética integral de la más alta calidad, utilizando tecnología de
											vanguardia y un enfoque personalizado para realzar la belleza natural de cada cliente.
										</p>
									</div>
								</div>
							</div>
						...
						{activeTab === 'equipo' && (
							<div className='animate-fade-in'>
								<div className='text-center mb-12'>
									<h2 className='text-3xl font-bold text-gray-900 mb-4'>Nuestro Equipo Profesional</h2>
									<p className='text-gray-600 max-w-2xl mx-auto'>
										Conocé a las profesionales que hacen posible que cada tratamiento sea una experiencia única y
										satisfactoria.
									</p>
								</div>
									...
									{equipoData.map((miembro, index) => (
										...
										>
											...
											<div className='p-6'>
												...
												<p className='text-primary-600 font-semibold mb-2'>{miembro.cargo}</p>
						...
						{activeTab === 'valores' && (
							<div className='animate-fade-in'>
								<div className='text-center mb-12'>
									<h2 className='text-3xl font-bold text-gray-900 mb-4'>Nuestros Valores y Principios</h2>
									<p className='text-gray-600 max-w-2xl mx-auto'>
										Estos son los pilares fundamentales que guían nuestro trabajo diario y definen la experiencia que
										ofrecemos a nuestras clientas.
									</p>
								</div>
			...
			<section className='bg-primary-500 bg-gradient-to-r from-primary-500 to-purple-600 text-white py-16'>
				<div className='max-w-4xl mx-auto px-4 text-center'>
					...
					<h2 className='text-3xl md:text-4xl font-bold mb-4'>¿Lista para Comenzar tu Transformación?</h2>
					<p className='text-xl text-primary-100 mb-8 max-w-2xl mx-auto'>
						Reservá tu consulta gratuita y descubrí cómo podemos ayudarte a alcanzar tus objetivos de belleza y
						bienestar.
					</p>
