...
export default function GiftCardsPage() {
  return (
		<div className='min-h-screen bg-pink-50 bg-gradient-to-br from-pink-50 via-white to-purple-50'>
			{/* Hero Section */}
			<section className='relative overflow-hidden pt-20 pb-16 px-4'>
				<div className='absolute inset-0 bg-pink-100/10 bg-gradient-to-r from-pink-100/20 to-purple-100/20' />
				<div className='relative max-w-7xl mx-auto'>
					<div className='text-center mb-12'>
						<h1 className='text-4xl md:text-6xl bg-pink-600 font-bold bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent mb-6'>
							Gift Cards
						</h1>
			...
			{/* CTA Section */}
			<section className='py-20 px-4 bg-pink-600 bg-gradient-to-r from-pink-600 to-purple-600'>
				<div className='max-w-4xl mx-auto text-center'>
					<h2 className='text-3xl md:text-4xl font-bold text-white mb-6'>¿Lista para regalar belleza?</h2>
